...
ALTER TABLE transactions AUTO_INCREMENT = 1401; # Pick something!
...
# Initial setup
grant usage ON *.* TO 'hauntix'@'localhost';    # Make users appear so following
grant usage ON *.* TO 'hauntix'@'%';            #  DROP's don't bomb.
